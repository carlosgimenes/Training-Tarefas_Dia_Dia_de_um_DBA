...
/*
Instru��es para realizar os testes.

Colocar a execu��o da procedure stpAlerta_Queries_Demoradas no JOB de Traces.
...
UPDATE [dbo].[Alerta_Parametro]
SET [Vl_Parametro] = 2
WHERE Nm_Alerta = 'Conex�o SQL Server'
...
/*******************************************************************************************************************************
--	Status Database / P�gina Corrompida
*******************************************************************************************************************************/
USE [master]
