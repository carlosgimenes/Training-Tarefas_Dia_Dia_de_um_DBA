...
**PAGE SPLIT**: A medida que dados são inseridos na página dos índices, quando uma página atinge 100% de utilização é necessário inserir mais uma linha nessa página, o SQL divide essa página em duas ficando 50% dos dados para cada página e isso é o que chamamos de PAGE SPLIT. Com o Page Split, a alocação de novas páginas, a exclusão de outras, os índices vão se fragmentando.
