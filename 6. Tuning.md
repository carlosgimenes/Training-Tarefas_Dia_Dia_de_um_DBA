...
Com base na `Modulo 06 - Tuning\Demo Procedure Carga Fragmentacao de Indice.sql` eu criei um notebook que chamei de `DatabaseFragmentacaoIndices.ipynb`, com respectivas adaptações, ver em: [Link para acesso ao repositório no GitHub com o código](https://github.com/carlosgimenes/SQL-Server-ceg-database-notebooks/blob/8e410155cfd6057acfbc47478bfa06aa67747df0/Tools/Helth%20Check/DatabaseFragmentacaoIndices.ipynb).
...
Com base na `Modulo 06 - Tuning\Demo Procedure REBUILD e REORGANIZE.sql` eu criei um notebook que chamei de `DatabaseRebuildReorganize.ipynb`, com respectivas adaptações, ver em: [Link para acesso ao repositório no GitHub com o código](https://github.com/carlosgimenes/SQL-Server-ceg-database-notebooks/blob/71433484e3b710797d8157b48bac276b660f7aff/Tools/Helth%20Check/DatabaseRebuildReorganize.ipynb).
